...
c.prototype=b.prototype;a.M=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.Hl=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
...
;var Dc={Jl:{value:!0,configurable:!0}};var Ec=Object,Fc=Ec.freeze,Gc=[];Array.isArray(Gc)&&!Object.isFrozen(Gc)&&Object.defineProperties(Gc,Dc);Fc.call(Ec,Gc);var K=window;sb("csi.gstatic.com");sb("googleads.g.doubleclick.net");sb("pagead2.googlesyndication.com");sb("partner.googleadservices.com");sb("pubads.g.doubleclick.net");sb("securepubads.g.doubleclick.net");sb("tpc.googlesyndication.com");var Hc={};function Ic(){}
...
;function Mc(a,b){a.src=xb(b);var c;b=(a.ownerDocument&&a.ownerDocument.defaultView||window).document;(c=(b=null===(c=b.querySelector)||void 0===c?void 0:c.call(b,"script[nonce]"))?b.nonce||b.getAttribute("nonce")||"":"")&&a.setAttribute("nonce",c)}
...
;var Df,Ef,Ff=y.window,Gf=(null===(Df=null===Ff||void 0===Ff?void 0:Ff.yt)||void 0===Df?void 0:Df.config_)||(null===(Ef=null===Ff||void 0===Ff?void 0:Ff.ytcfg)||void 0===Ef?void 0:Ef.data_)||{};A("yt.config_",Gf,void 0);function N(a){for(var b=0;b<arguments.length;++b);Cf(Gf,arguments)}
...
;var Mf=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};A("yt.msgs_",Mf,void 0);function Nf(a){Cf(Mf,arguments)}
...
;var Qf=0,Rf=mc?"webkit":lc?"moz":jc?"ms":ic?"o":"";A("ytDomDomGetNextId",B("ytDomDomGetNextId")||function(){return++Qf},void 0);var Sf={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,screenX:1,screenY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};
...
Tf.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var fb=y.ytEventsEventsListeners||{};A("ytEventsEventsListeners",fb,void 0);var Vf=y.ytEventsEventsCounter||{count:0};A("ytEventsEventsCounter",Vf,void 0);
...
function kg(a){var b=void 0===a?{}:a;a=void 0===b.kb?!1:b.kb;b=void 0===b.Ua?!0:b.Ua;if(null==B("_lact",window)){var c=parseInt(F("LACT"),10);c=isFinite(c)?Date.now()-Math.max(c,0):-1;A("_lact",c,window);A("_fact",c,window);-1==c&&lg();Yf(document,"keydown",lg);Yf(document,"keyup",lg);Yf(document,"mousedown",lg);Yf(document,"mouseup",lg);a?Yf(window,"touchmove",function(){mg("touchmove",200)},{passive:!0}):(Yf(window,"resize",function(){mg("resize",200)}),b&&Yf(window,"scroll",function(){mg("scroll",200)}));
...
function lg(){null==B("_lact",window)&&kg();var a=Date.now();A("_lact",a,window);-1==B("_fact",window)&&A("_fact",a,window);(a=B("ytglobal.ytUtilActivityCallback_"))&&a()}
function ng(){var a=B("_lact",window);return null==a?-1:Math.max(Date.now()-a,0)}
;function og(){var a=pg;B("yt.ads.biscotti.getId_")||A("yt.ads.biscotti.getId_",a,void 0)}
function qg(a){A("yt.ads.biscotti.lastId_",a,void 0)}
...
A("yt.ads_.signals_.getAdSignalsString",function(a){return wg(Bg(a))},void 0);var Dg="XMLHttpRequest"in y?function(){return new XMLHttpRequest}:null;
...
;var Hh=y.ytLoggingGelSequenceIdObj_||{};A("ytLoggingGelSequenceIdObj_",Hh,void 0);function Ih(a,b,c,d){d=void 0===d?{}:d;var e={},f=Math.round(d.timestamp||P());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;a=ng();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};O("log_sequence_info_on_gel_web")&&d.U&&(a=e.context,b=d.U,Hh[b]=b in Hh?Hh[b]+1:0,a.sequence={index:Hh[b],groupKey:b},d.Va&&delete Hh[d.U]);(d.Pl?Ah:wh)({endpoint:"log_event",payload:e,F:d.F,ja:d.ja},c)}
...
;var Lh=B("ytglobal.prefsUserPrefsPrefs_")||{};A("ytglobal.prefsUserPrefsPrefs_",Lh,void 0);function Mh(){this.h=F("ALT_PREF_COOKIE_NAME","PREF");this.i=F("ALT_PREF_COOKIE_DOMAIN","youtube.com");var a=md.get(""+this.h,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Lh[d]=c.toString())}}}
...
function Uh(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||F("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Gl||F("AUTHORIZATION"))||(a?b="Bearer "+B("gapi.auth.getToken")().Fl:b=qd([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=F("SESSION_INDEX",0),O("pageid_as_header_web")&&(d["X-Goog-PageId"]=F("DELEGATED_SESSION_ID")));return d}
...
ci.prototype.toString=function(){return this.topic};var di=B("ytPubsub2Pubsub2Instance")||new M;M.prototype.subscribe=M.prototype.subscribe;M.prototype.unsubscribeByKey=M.prototype.da;M.prototype.publish=M.prototype.W;M.prototype.clear=M.prototype.clear;A("ytPubsub2Pubsub2Instance",di,void 0);var ei=B("ytPubsub2Pubsub2SubscribedKeys")||{};A("ytPubsub2Pubsub2SubscribedKeys",ei,void 0);var fi=B("ytPubsub2Pubsub2TopicToKeys")||{};A("ytPubsub2Pubsub2TopicToKeys",fi,void 0);var gi=B("ytPubsub2Pubsub2IsAsync")||{};A("ytPubsub2Pubsub2IsAsync",gi,void 0);
A("ytPubsub2Pubsub2SkipSubKey",null,void 0);function hi(a,b){var c=ii();c&&c.publish.call(c,a.toString(),a,b)}
...
{objectStoreNames:c,
dbName:b});if("AbortError"===e.name)return new R("UNKNOWN_ABORT",{objectStoreNames:c,dbName:b},e.message);e.args=[{name:"IdbError",Ll:e.name,dbName:b,objectStoreNames:c}];e.level="WARNING";return e}
...
v(T,He);function ek(){if(!T.h){var a=B("yt.networkStatusManager.instance")||new T;A("yt.networkStatusManager.instance",a,void 0);T.h=a}return T.h}
...
;var ik=!1,jk,kk=0,lk=0,mk,nk=y.ytNetworklessLoggingInitializationOptions||{isNwlInitialized:ik,databaseToken:jk,potentialEsfErrorCounter:lk,isIdbSupported:!!jk};A("ytNetworklessLoggingInitializationOptions",nk,void 0);
...
function Gh(a,b,c,d){function e(r){r=void 0===r?!1:r;var p;if(d.retry&&"www.youtube-nocookie.com"!=h&&(r||(p=Zh(b,c,l,k)),p)){var z=g.onSuccess,I=g.onFetchSuccess;g.onSuccess=function(E,Q){$h(p);z(E,Q)};
...
Jk();c=u(a.T);for(d=c.next();!d.done;d=c.next())if(d=d.value,l.message&&l.message.match(d.Kl)){a=d.weight;break a}a=u(a.P);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.Ea(l)){a=c.weight;break a}a=1}l.sampleWeight=a;a=u(Ek);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.ma[l.name])for(e=u(c.ma[l.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=l.message.match(f.regexp)){l.params["params.error.original"]=d[0];e=f.groups;f={};for(g=0;g<e.length;g++)f[e[g]]=d[g+1],l.params["params.error."+e[g]]=
format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},jl=null;function pg(){if(O("condition_biscotti_fetch_on_consent_cookie_html5_clients")&&!gl())return Ye(Error("User has not consented - not fetching biscotti id."));if("1"==ib())return Ye(Error("Biscotti ID is not available in private embed mode"));jl||(jl=$e($k().then(kl),function(a){return ll(2,a)}));
return jl}
...
return a.join("")}
;var rl,sl=y.ytLoggingDocDocumentNonce_;sl||(sl=ql(),Ra("ytLoggingDocDocumentNonce_",sl));rl=sl;var tl={Ie:0,jc:1,sc:2,Oh:3,Ke:4,ll:5,Hi:6,Jj:7,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE"};function ul(a){this.h=a}
...
A("yt_logging_screen.getRootVeType",yl,void 0);function zl(a){return(a=yl(void 0===a?0:a))?new ul({veType:a,youtubeData:void 0}):null}
...
A("yt_logging_screen.getCurrentCsn",Bl,void 0);function Cl(a,b,c){var d=Al();(c=Bl(c))&&delete d[c];b&&(d[a]=b)}
function Dl(a){return Al()[a]}
A("yt_logging_screen.getCttAuthInfo",Dl,void 0);function El(a,b,c,d){c=void 0===c?0:c;if(a!==F(wl(c))||b!==F(xl(c)))Cl(a,d,c),N(wl(c),a),N(xl(c),b),b=function(){setTimeout(function(){a&&Ih("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:rl,clientScreenNonce:a},Ck)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b()}
A("yt_logging_screen.setCurrentScreen",El,void 0);function Fl(a){bi.call(this,1,arguments);this.csn=a}
...
;function jm(){var a=B("ytcsi.debug");a||(a=[],A("ytcsi.debug",a,void 0),A("ytcsi.reference",{},void 0));return a}
...
;var lm=y.ytLoggingLatencyUsageStats_||{};A("ytLoggingLatencyUsageStats_",lm,void 0);function mm(){this.h=0}
...
gesturedVe:h.visualElement.getAsJson()}:h&&Wk(new vi("newScreen() parent element does not have a VE - rootVe",b));l&&(r.cloneCsn=l);l={F:n,U:q};k?Ih("screenCreated",r,k,l):Dk("screenCreated",r,l);hi(ki,new Fl(q));var p=q}catch(z){Yk(z,{Nl:b,rootVe:d,parentVisualElement:void 0,Il:e,Ml:f,Ga:c.Ga});Xk(z);return}El(p,b,c.layer,c.F);if((b=e&&"UNDEFINED_CSN"!==e&&d)&&!(b=O("screen_manager_skip_hide_killswitch"))){a:{b=u(Object.values(tl));for(f=b.next();!f.done;f=b.next())if(Bl(f.value)==e){b=!0;break a}b=
...
var Vm={};var Zm=[],$m=!1;function an(){if((!O("condition_ad_status_fetch_on_consent_cookie_html5_clients")||gl())&&"1"!=ib()){var a=function(){$m=!0;"google_ad_status"in window?N("DCLKSTAT",1):N("DCLKSTAT",2)};
...
a.N=!0;b?a.A():(Sm(Wn(a),a.A),(b=$n(a))&&In(b),ao(a)&&!c&&A("yt.player.Application.create",null,void 0))}}}
...
;A("yt.setConfig",N,void 0);A("yt.config.set",N,void 0);A("yt.setMsg",Nf,void 0);A("yt.msgs.set",Nf,void 0);A("yt.logging.errors.log",Xk,void 0);
A("writeEmbed",function(){var a=F("PLAYER_CONFIG",void 0);if(!a){var b=F("PLAYER_VARS",void 0);b&&(a={args:b})}ol(!0);"gvn"===a.args.ps&&(document.body.style.backgroundColor="transparent");a.attrs||(a.attrs={width:"100%",height:"100%",id:"video-player"});var c=document.referrer;b=F("POST_MESSAGE_ORIGIN");window!==window.top&&c&&c!==document.URL&&(a.args.loaderUrl=c);O("embeds_js_api_set_1p_cookie")&&(c=yg(),c.embedsTokenValue&&(a.args.embedsTokenValue=c.embedsTokenValue));N("FORCE_CSI_ON_GEL",!0);
